...
def test_Variable__init__() -> None:
    try:
        ...
        assert str(e) == (
            "Invalid name=12 for a Variable."
            " Provided name is of type <class 'int'>,"
    ...
    try:
        ...
        assert isinstance(e, TypeError)
        assert str(e) == (
            "Invalid name=None for a Variable."
            " Provided name is of type <class 'NoneType'>,"
            " but it should be of type <class 'str'>."
        )
    ...
    try:
        ...
        assert isinstance(e, TypeError)
        assert str(e) == (
            "Invalid name=(1, 2) for a Variable."
            " Provided name is of type <class 'tuple'>,"
            " but it should be of type <class 'str'>."
        )
    ...
    try:
        ...
        assert isinstance(e, TypeError)
        assert str(e) == (
            "Variable named 'aa' has values=(1.0, 4.5, 7.8)"
            " of type <class 'tuple'>,"
            " but it should be of type <class 'list'>."
        )
    ...
    try:
        ...
        assert isinstance(e, TypeError)
        assert str(e) == (
            "Variable named 'aa' has values={'a': 1.0, 'b': 4.5, 'c': 7.8}"
            " of type <class 'dict'>,"
            " but it should be of type <class 'list'>."
        )
    ...
    try:
        ...
        assert str(e) == (
            "Multiple value types for a Variable named 'cc' with values=[1, 5, 7]."
            " Encountered value types:\n"
            "1 : <class 'numpy.int32'>\n"
            "5 : <class 'numpy.int32'>\n"
            "7 : <class 'int'>\n"
    ...
    try:
        ...
        assert isinstance(e, RuntimeError)
        assert str(e) == (
            "All values=[1, 5, 7] for a Variable named 'dd'"
            " are of type <class 'numpy.int32'>, which is not allowed."
            " Please use one of:"
            " (<class 'float'>, <class 'int'>, <class 'str'>, <class 'bool'>)."
        )
...
def test_Variable__str__() -> None:
    assert str(Variable(name="ff", values=[1.0, 4.5, 7.8])) == (
        "Variable(\n"
        "    name='ff',\n"
        "    values=[1.0, 4.5, 7.8],\n"
        "    vtype=<class 'float'>,\n"
    ...
    assert str(Variable(name="bb", values=[True, False])) == (
        "Variable(\n"
        "    name='bb',\n"
        "    values=[True, False],\n"
        "    vtype=<class 'bool'>,\n"
    ...
    assert str(Variable(name="ii", values=[32, 64, 128, 256, 512])) == (
        "Variable(\n"
        "    name='ii',\n"
    ...
    assert str(Variable(name="cc", values=["x", "y", "z"])) == (
        "Variable(\n"
        "    name='cc',\n"
        "    values=['x', 'y', 'z'],\n"
        "    vtype=<class 'str'>,\n"
